...
![Database Queries](https://img.shields.io/badge/SQL-Normalization%20%26%20Queries-005C8A?style=for-the-badge&logo=sqlite&logoColor=white)

### AI, LLM & Local Development Tools
![PyTorch](https://img.shields.io/badge/PyTorch-EE4C2C?style=for-the-badge&logo=pytorch&logoColor=white)
![Ollama](https://img.shields.io/badge/Ollama-Local%20LLMs-black?style=for-the-badge&logo=ollama&logoColor=white)
![Claude Code](https://img.shields.io/badge/Claude%20Code-AI%20Assistant-D97706?style=for-the-badge&logo=anthropic&logoColor=white)
![Qwen](https://img.shields.io/badge/Qwen-Local%20Models-7C3AED?style=for-the-badge)

---

## 📌 Featured Projects

### 🧠 [CAPC-IRSRNet] - Deep Learning Research Project
> **Architecture & Model Design**
- Designed an academic deep learning model module integrating **cross-modal attention** mechanisms.
- Structured the architectural workflow leading into a dedicated **confidence estimation** module for improved prediction reliability.

### 🔐 Dynamic & Secure QR Code Attendance System
> **Authentication & Scanning Infrastructure**
- Created technical module specifications for secure user authentication, dynamic QR generation, and real-time scanning validation.
- Engineered to prevent proxy attendance using dynamic time-based token generation and validation layers.

### ⚙️ Local AI Developer Workflows & System Optimization
> **LLM Tooling & Local Inference**
- Configured and deployed open-weight LLMs (Qwen) locally using **Ollama** paired with CLI AI coding assistants (Claude Code, Cline).
- Optimized model memory allocation and execution pipelines across local GPU setups for low-latency coding workflows.
## 📌 Featured Projects
